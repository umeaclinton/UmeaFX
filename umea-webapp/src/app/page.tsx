  ...
  return (
    <main className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-slate-100 flex flex-col justify-between selection:bg-emerald-500 selection:text-white transition-colors duration-200">
      ...
      <section className="relative px-4 sm:px-6 pt-16 pb-20 lg:pt-24 lg:pb-28 max-w-7xl mx-auto flex flex-col items-center text-center">
        {/* Status Pill */}
        <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-xs font-semibold mb-8 text-gray-600 dark:text-slate-300 shadow-inner">
        ...
        <div className="w-full max-w-5xl mt-16 p-5 sm:p-8 rounded-3xl glass-card glass-card-hover border border-gray-200 dark:border-white/8 text-left relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 text-left w-full">
          <div className="p-7 rounded-3xl glass-card glass-card-hover border border-gray-200 dark:border-white/8">
      ...
      <section className="px-4 sm:px-6 py-24 max-w-6xl mx-auto text-center w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 max-w-4xl mx-auto text-left">
          {/* Partner Tier */}
          <div className="relative p-7 sm:p-9 rounded-3xl bg-gradient-to-b from-emerald-50 dark:from-emerald-950/30 via-white dark:via-black to-white dark:to-black border-2 border-emerald-500/50 shadow-2xl shadow-emerald-500/10 flex flex-col justify-between">
          ...
          <div className="p-7 sm:p-9 rounded-3xl glass-card border border-gray-200 dark:border-white/8 flex flex-col justify-between">
            <div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/60 dark:bg-black/85 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-white dark:bg-[#0D121C] border border-gray-200 dark:border-white/8 rounded-3xl max-w-md w-full p-6 sm:p-8 relative shadow-2xl">
            <button
